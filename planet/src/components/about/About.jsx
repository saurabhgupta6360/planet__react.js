...
const About = () => {
  return (
    <>
      <div className="container mx-auto grid lg:grid-cols-1 pt-4 pb-20 text-white ">
        <h1 className="title md:text-6xl lg:text-6xl xs:text-6xl lg:my-20 sm:my-20 xs:my-20 text-we font-medium">
          About
        </h1>
        <p>
